"""Financial Forecasting Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Financial forecasting agent that builds revenue and expense projections, models cash flow scenarios, forecasts working capital needs, and provides budget variance predictions.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
