"""Financial Forecasting Agent - Main Agent Implementation."""
...
class FinancialForecastingAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self.financial_enabled = True
        self.forecasting_enabled = True
        self.compliance_enabled = True
        self.reporting_enabled = True
        self._tool_dispatch = {
            "forecast_revenue": self.tools.forecast_revenue,
            "project_expenses": self.tools.project_expenses,
            "model_cash_flow": self.tools.model_cash_flow,
            "forecast_working_capital": self.tools.forecast_working_capital,
            "predict_variance": self.tools.predict_variance,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['financial', 'forecasting', 'compliance', 'reporting'],
        )
    ...
    async def process_message(self, request: ChatRequest, user_id: str) -> ChatResponse:
        ...
        rag_results = await self.rag_pipeline.retrieve(
            ...
            top_k=5,
            filters={"user_id": user_id, "domain": "finance"},
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "model_cash_flow": ['model', 'cash', 'flow'],
            "forecast_working_capital": ['forecast', 'working', 'capital'],
            "predict_variance": ['predict', 'variance'],
        }
