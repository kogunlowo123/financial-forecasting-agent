"""Financial Forecasting Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Financial Forecasting Agent through a multi-step pipeline.
