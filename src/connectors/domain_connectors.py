"""Financial Forecasting Agent - Domain-Specific Connectors."""
...
class NetsuiteConnector:
    """Domain-specific connector for netsuite integration with Financial Forecasting Agent."""
...
class QuickbooksConnector:
    """Domain-specific connector for quickbooks integration with Financial Forecasting Agent."""
...
class XeroConnector:
    """Domain-specific connector for xero integration with Financial Forecasting Agent."""
...
class SapConnector:
    """Domain-specific connector for sap integration with Financial Forecasting Agent."""
...
class OracleFinancialsConnector:
    """Domain-specific connector for oracle financials integration with Financial Forecasting Agent."""
